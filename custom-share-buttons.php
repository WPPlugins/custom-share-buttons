...
Description: A custom custom plugin that enables you to add share buttons to all of your posts and/or pages.
Version: 1.0
...
*/
	...
	function csbtns_activate() {
		...
		// share text
		add_option('csbtns_share_text', 			"Don't be shellfish...");
	...
	function mywidget_init() {
		...
		register_sidebar_widget('Share Buttons Widget', 'csbtns_widget');
		register_widget_control('Share Buttons Widget', 'csbtns_widget_control');
	}
	...
	function csbtns_menu() {
		...
		// add menu page
		add_options_page( 'Custom Share Buttons', 'Share Buttons', 'manage_options', 'custom-share-buttons', 'csbtns_settings');
