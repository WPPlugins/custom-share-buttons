...
function csbtns_admin_panel($arrSettings, $htmlSettingsSaved) {
	...
	$htmlShareButtonsForm .= '<a id="csbtns_tab_basic" class="csbtns-selected-tab" href="javascript:;">Basic</a>';
	$htmlShareButtonsForm .= '<a id="csbtns_tab_styling" href="javascript:;">Styling</a>';
	$htmlShareButtonsForm .= '<a id="csbtns_tab_counters" href="javascript:;">Counters</a>';
	$htmlShareButtonsForm .= '<a id="csbtns_tab_advanced" href="javascript:;">Advanced</a>';
			...
			$htmlShareButtonsForm .= '<div id="csbtns_settings_basic">';
				...
				$htmlShareButtonsForm .= '<table class="form-table">';
					...
					$htmlShareButtonsForm .= '<tr valign="top">';
						...
						$htmlShareButtonsForm .= '<p class="description">Check all those that you wish to show your share buttons</br>Note you can also show&#47;hide your buttons using &#91;csbtns&#93; and &#91;csbtns&#95;hide&#93;</p></td>';
					$htmlShareButtonsForm .= '</tr>';
					$htmlShareButtonsForm .= '<tr valign="top">';
						$htmlShareButtonsForm .= '<th scope="row" style="width: 120px;"><label for="csbtns_before_or_after">Placement:&nbsp;</label></th>';
					...
					$htmlShareButtonsForm .= '</tr>';
					$htmlShareButtonsForm .= '<tr valign="top">';
						$htmlShareButtonsForm .= '<th scope="row" style="width: 120px;"><label for="csbtns_image_set">Image Set:&nbsp;</label></th>';
						...
						$htmlShareButtonsForm .= '</select>';
						$htmlShareButtonsForm .= '<p class="description">You can make your own <a href="http://make.mrwebsolution.in" target="blank"><strong>custom-coloured share buttons here</strong></a>! Choose your favourite set of buttons, or set to &#39;Custom&#39; to choose your own. <a href="http://www.mrwebsolution.in/button-sets/" target="_blank">Click here</a> to preview the button sets</br>';
...
CODE;
	...
	$htmlShareButtonsForm .= '	<div class="csbtns-box csbtns-shadow">
										...
										<div class="author-shortcodes">
											<div class="author-inner">
												...
												<div class="author-info">
													<a href="http://raghunathgurjar.wordpress.com" target="_blank">Raghunath</a> – Website freelancer. This plugin and its website has been funded by myself.
												</div> <!-- .author-info -->
											</div> <!-- .author-inner -->
									...
									<table class="centerme">
										...
										<tr>
											<td><a href="http://twitter.com/share?url=http://www.mrwebsolution.in&text=Custom Share Buttons" target="_blank" title="Tweet">Tweet about Custom Share Buttons<br/><img src="' . plugins_url() . '/custom-share-buttons/images/tweet.png"></a></td>
										<tr>
											<td><a href="http://www.facebook.com/sharer.php?u=http://www.mrwebsolution.in" target="_blank" title="Share on Facebook">Share on Facebook<br/><img src="' . plugins_url() . '/custom-share-buttons/images/share.png"></a></td>
										</tr>
									</table>
								</div>';
